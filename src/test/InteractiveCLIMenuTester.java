 ...
 * A simple tool to recursively test CLI menu navigation by simulating user inputs
 */
public class InteractiveCLIMenuTester {
    ...
    private String processMenuChoice(String currentMenu, String choice) {
        ...
        switch (currentMenu) {
            case "MAIN":
                switch (choice) {
                    case "1": return "EXPENDITURE";
                    case "2": return "CATEGORY";
                    case "3": return "BANK";
                    case "4": return "RECEIPT";
                    case "5": return "ANALYTICS";
                    case "6": return "MAIN"; // View alerts stays in main
                    case "7": return "HELP";
                    case "8": case "exit": return null; // Exit
                    default: return null;
                }
            ...
            case "EXPENDITURE":
                switch (choice) {
                    ...
                    case "9": return "MAIN"; // Return to main
                    default: return null;
                }
            ...
            case "CATEGORY":
                switch (choice) {
                    ...
                    case "6": return "MAIN"; // Return to main
                    default: return null;
                }
            ...
            case "RECEIPT":
                switch (choice) {
                    ...
                    case "5": return "MAIN"; // Return to main
                    default: return null;
                }
            ...
            case "HELP":
                switch (choice) {
                    ...
                    case "3": case "exit": return "MAIN"; // Return to main
                    default: return null;
                }
