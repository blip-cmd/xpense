...
javac -cp src src/test/SimpleCLIMenuTester.java
if %errorlevel% equ 0 (
    echo │ ✓ Compilation successful!                                  │
    echo └────────────────────────────────────────────────────────────┘
    echo.
    java -cp src test.SimpleCLIMenuTester
) else (
    echo │ ✗ Compilation failed!                                     │
    echo └────────────────────────────────────────────────────────────┘
)
...
javac -cp src src/app/Main.java
if %errorlevel% equ 0 (
    java -cp src app.Main < test_basic_navigation.txt
) else (
    echo Compilation failed!
)
pause
...
javac -cp src src/app/Main.java
if %errorlevel% equ 0 (
    java -cp src app.Main < test_invalid_inputs.txt
) else (
    echo Compilation failed!
)
pause
...
javac -cp src src/app/Main.java
if %errorlevel% equ 0 (
    java -cp src app.Main < test_complex_navigation.txt
) else (
    echo Compilation failed!
)
pause
...
echo │ Basic Navigation Test:     test_basic_navigation.txt       │
echo │ Invalid Input Test:        test_invalid_inputs.txt         │
echo │ Complex Navigation Test:   test_complex_navigation.txt     │
echo │ Interactive Tester:        src/test/InteractiveCLIMenuTester.java │
echo │ Simple Guide:              src/test/SimpleCLIMenuTester.java     │
echo └────────────────────────────────────────────────────────────┘
echo.
